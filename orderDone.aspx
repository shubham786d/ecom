<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="orderDone.aspx.cs" Inherits="ecom.orderDone" %>
    ...
    <div class="container-fluid ">
        <div class=" box">
            <div style="margin: auto">
                <img class="img-responsive" src="img/cele.jpg" />
            </div>
            <div class="row">
                <div class="col-sm-8">
                    <p style="color: #388e3c; font-size: 24px; font-weight: 500;">
                        Thank you for your order!</p>
                    <p style="font-size: 14px; line-height: 1.4;">
                        Your order has been placed and is being processed. When the item(s) are shipped,you
                        will receive an email with the details. You can track this order through <a href="/Myorders.aspx"> My Orders</a>
                        page.</p>
                </div>
            </div>
        </div>
